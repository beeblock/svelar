...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      'svelar/logging/LogViewer': resolve(svelarRoot, 'dist/logging/LogViewer.js'),
      ...
      'svelar/pdf': resolve(svelarRoot, 'dist/pdf/index.js'),
      'svelar/pdf/GeneratePdfJob': resolve(svelarRoot, 'dist/pdf/GeneratePdfJob.js'),
      ...
      'svelar/queue/JobMonitor': resolve(svelarRoot, 'dist/queue/JobMonitor.js'),
      ...
      'svelar/scheduler/ScheduleMonitor': resolve(svelarRoot, 'dist/scheduler/ScheduleMonitor.js'),
      ...
      'svelar/excel': resolve(svelarRoot, 'dist/excel/index.js'),
      'svelar/feature-flags': resolve(svelarRoot, 'dist/feature-flags/index.js'),
